...
taugss1 = -0.010005650786972;

Ygss1 =   0.944458979184669          ;
Ybss1 =   0.666871978063001      ;
...
taugss2 = -0.010005650786972;
Ygss2 =       0.997193812324159     ;
Ybss2 =  0.685337270711154        ;
...
// -------------------------------------------------------------------------------------- //
//CH variables
moni3.Y          = (Y/Yss1-1)*100;
moni3.Kb          = (Kb/Kbss1-1)*100;
moni3.Kg          = (Kg/Kgss1-1)*100;

moni3.I         = ((Ig+Ib)/(Igss1+Ibss1)-1)*100;

moni3.e          = (e/ess1-1)*100;
moni3.N          = (N/Nss1-1)*100;
moni3.L = (L/Lss1-1)*100;
moni3.Yg = (Yg/Ygss1-1)*100;
moni3.Yb = (Yb/Ybss1-1)*100;
moni3.Qg = (Qg/Qgss1-1)*100;
moni3.Qb = (Qb/Qbss1-1)*100;
moni3.W = (W/Wss1-1)*100;
moni3.pg = (pg/pgss1-1)*100;
moni3.pb = (pb/pbss1-1)*100;
moni3.C = (C/Css1-1)*100;
