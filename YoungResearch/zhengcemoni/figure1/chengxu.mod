...
%omegabar = 8.3849;
omegabar =   7.786260946547598; %标靶为劳动时间为三分之一
rhoL = 1;
%alphab = 0.35;
%alphag = 0.33;
alphab = 0.37;%陆磊取值为0.35，考虑到一些文献（举例）中棕色比绿色要高，因此，我们再0.35基础上进行调整，棕色+0.02得0.37，绿色-0.02得0.33
alphag = 0.33;
...
moni.taue = (tauess2/tauess1-1)*199.8/tauess2;
