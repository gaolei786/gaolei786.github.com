...
// -------------------------------------------------------------------------------------- //
//CH variables
moni2.Y          = (Y/Yss1-1)*100;
moni2.Kb          = (Kb/Kbss1-1)*100;
moni2.Kg          = (Kg/Kgss1-1)*100;

moni2.I         = ((Ig+Ib)/(Igss1+Ibss1)-1)*100;

moni2.e          = (e/ess1-1)*100;
moni2.N          = (N/Nss1-1)*100;
moni2.L = (L/Lss1-1)*100;
moni2.Yg = (Yg/Ygss1-1)*100;
moni2.Yb = (Yb/Ybss1-1)*100;
moni2.Qg = (Qg/Qgss1-1)*100;
moni2.Qb = (Qb/Qbss1-1)*100;

moni2.pg = (pg/pgss1-1)*100;
moni2.pb = (pb/pbss1-1)*100;
moni2.W = (W/Wss1-1)*100;
moni2.C = (C/Css1-1)*100;
