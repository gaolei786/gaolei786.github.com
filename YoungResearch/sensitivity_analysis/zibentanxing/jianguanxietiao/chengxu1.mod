...
%omegabar = 8.3849;
omegabar =   7.614992976722937;
rhoL = 1;
%alphab = 0.35;
%alphag = 0.33;
alphab = 0.35;%国际上通常取值1/3，但我国资本在收入份额中所占比例相对较高	陆磊（2020）
alphag = 0.33;
...
%theta1 = 0.0335;
theta1 =0.033617261515243;
theta2 = 2.6;
d0 = -0.0076;
%d1 = 1.522550102017574*10^(-5);
%d2 =  3.709902078663939*10^(-8);
d1 =     6.521783103264641*10^(-05);
d2 =     6.806940647512513*10^(-07);
...
%erow = 3.1499;
erow = 1.537263323473770;
rhoY = 2;
%paib = 0.3326;
paib = 0.333861794877966;
% kappa = 0.3409;
kappa = 0.482844896912569;
gamma = 0.972;
% zeta = 0.003;
...
Ass1 = 1;
taubss1 =0.009531221185826  ;
taugss1 = -0.004604446418668;
Ygss1 =    0.773990059679556         ;
Ybss1 =    0.509049301157085     ;
...
tauess2 = 0.040761;
Ass2 = 1;
taubss2 = 0.009531221185826  ;
taugss2 = -0.004604446418668 ;
Ygss2 =  0.808385849751421        ;
Ybss2 = 0.517672216935116     ;
