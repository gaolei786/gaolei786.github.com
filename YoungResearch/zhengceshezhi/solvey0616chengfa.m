%利用myfun函数求解yss
fun1 = @myfun0616chengfa;
options=optimset('Maxfuneval',50000, 'MaxIter', 6000, 'TolFun',1e-50);
[yss] = fsolve(fun1, [0.8, 0.7, 0.002],options )

Ygss = yss(1);
Ybss = yss(2);
taubss = yss(3);
Ygss = 0.710153435188069 ;
Ybss =  0.486784522543177;
taubss = 0.013771174144808;;
