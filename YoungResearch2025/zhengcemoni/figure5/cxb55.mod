...
//*****************外生变量定义***********************************
varexo
tau_b tau_e tau_g  tau_z tau_gt A kappa_b kappa_g
;
//*****************参数定义******************************
parameters
...
Iss1 Sbss1 Sgss1 Dss1 Nss1 phiss1 chi_bss1 chi_gss1 nuss1 kappa_bss1 kappa_gss1 
...
Iss2 Sbss2 Sgss2 Dss2 Nss2 phiss2 chi_bss2 chi_gss2 nuss2 kappa_bss2 kappa_gss2
;
...
tau_gtss1 = 0;
tau_zss1 =  0;
Ygss1 =  0.616074271522613;
Ybss1 =  0.770731160783034;
Cgss1 =  0.445691416250746;
Cbss1 =  0.599381095442766  ;
...
phiss1 = kappa*( kappa_bss1*Qbss1*Sbss1 + kappa_gss1*Qgss1*Sgss1 )/Nss1; %B.13
...
tau_gtss2 = 0;
tau_zss2 = 0;
Ygss2 =  0.572552337806970 ;
Ybss2 =  0.836845900220922 ;
Cgss2 =  0.428553809236124;
Cbss2 =   0.631233781195944 ;
kappa_bss2 = 1.485;
kappa_gss2 = 0.125;
...
phiss2 = kappa*( kappa_bss2*Qbss2*Sbss2 + kappa_gss2*Qgss2*Sgss2 )/Nss2; %B.13
...
moni5.Y          = (Y/Y(1)-1)*100;
moni5.Yb          = (Yb/Yb(1)-1)*100;
moni5.Yg          = (Yg/Yg(1)-1)*100;
moni5.Kb          = (Kb/Kb(1)-1)*100;
moni5.Kg          = (Kg/Kg(1)-1)*100;
moni5.Qb          = (Qb/Qb(1)-1)*100;
moni5.Qg          = (Qg/Qg(1)-1)*100;
moni5.I         = (I/I(1)-1)*100;
moni5.C         = (C/C(1)-1)*100;
moni5.e_b        = (e_b/e_b(1)-1)*100;
moni5.N          = (N/N(1)-1)*100;
moni5.L          = (L/L(1)-1)*100;
moni5.p_g = (p_g/p_g(1)-1)*100;
moni5.p_b = (p_b/p_b(1)-1)*100;