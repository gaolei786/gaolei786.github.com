...
horizon=20;
 ...
 plot([1:1:21]', moni2.Y(1+moni.M_.maximum_lag-1:horizon+moni.M_.maximum_lag),'-k','LineWidth',5, 'Color',[255/255 0/255 0/255] );hold on;
  plot([1:1:21]', moni3.Y(1+moni.M_.maximum_lag-1:horizon+moni.M_.maximum_lag),'-.k','LineWidth',5, 'Color',[0 114/255 189/255] );hold on;
...
plot([1:1:21]', moni4.e_b(1+moni.M_.maximum_lag-1:horizon+moni.M_.maximum_lag),'--k','LineWidth',5, 'Color',[230/255 180/255 40/255] );hold on;
...
ylim([-20 20])
%set(gca,'position',[.05  .05  .90  .88])
longLabel = sprintf('碳税+消费者偏好\n+宏观审慎政策冲击'); % 生成带换行的字符串
legend( {'碳税','消费者偏好','碳税+消费者偏好',longLabel},'FontSize',15,'Location','NorthEast')
