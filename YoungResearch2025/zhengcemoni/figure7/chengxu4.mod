...
//*****************外生变量定义***********************************
varexo
tau_b tau_e tau_g  tau_z tau_gt A pi_b
;
//*****************参数定义******************************
parameters
...
kappa kappa_b kappa_g gamma zeta  
...
Ygss1 = 0.616731040633645 ;
Ybss1 =0.770094266400973;
Cgss1 = 0.445935796571420;
Cbss1 =0.599061110598550;
...
Ygss2 = 0.757317810326025;
Ybss2 =  0.710907917869803;
Cgss2 =  0.547588979238797;
Cbss2 = 0.553077786424095;
...
moni4.Y          = (Y/Y(1)-1)*100;
moni4.Yb          = (Yb/Yb(1)-1)*100;
moni4.Yg          = (Yg/Yg(1)-1)*100;
moni4.Kb          = (Kb/Kb(1)-1)*100;
moni4.Kg          = (Kg/Kg(1)-1)*100;
moni4.Qb          = (Qb/Qb(1)-1)*100;
moni4.Qg          = (Qg/Qg(1)-1)*100;
moni4.L         = (L/L(1)-1)*100;
moni4.I         = (I/I(1)-1)*100;
moni4.C         = (C/C(1)-1)*100;
moni4.e_b        = (e_b/e_b(1)-1)*100;
moni4.N          = (N/N(1)-1)*100;
moni4.p_g = (p_g/p_g(1)-1)*100;
moni4.p_b = (p_b/p_b(1)-1)*100;